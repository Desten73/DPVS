...
namespace CHARACTERS
{
    public abstract class Character
    {
        ...
        {
            Debug.Log("Show/Hide нельз€ вызывать из базового типа персонажа");
            yield return null;
        }
        ...
        {
            Debug.Log("ChangingColor не определена дл€ данного типа персонажа!");
            yield return null;
        }
        ...
        {
            Debug.Log("¬ыделение не работает дл€ данного типа персонажа!");
            yield return null;
        }
